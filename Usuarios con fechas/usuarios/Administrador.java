...
public class Administrador extends Usuario implements EmpleadoUtils {
    ...
    public Administrador(String nombre, String apellido, LocalDate fechaNacimiento, String teléfono, String nombreUsuario, String contraseña,
        Double sueldo, String RFC, String INE) {
        super(nombre, apellido, teléfono, Rol.GERENTE, nombreUsuario, contraseña, fechaNacimiento);
        this.sueldo = sueldo;
        this.RFC = RFC;
        this.INE = INE;
    }
    ...
    public static void registrarGerente() {
        ...
        if (rol == Rol.GERENTE) {
            ...
            Administrador newAdmin = new Administrador(nombre, apellido, fechaNacimiento, telefono, 
                    nombreUsuario, nombreUsuario, sueldo, clave, INE);
