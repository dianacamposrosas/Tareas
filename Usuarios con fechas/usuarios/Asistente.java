...
public class Asistente extends Usuario implements EmpleadoUtils {
    ...
    public Asistente(String nombre, String apellido, LocalDate fechaNacimiento, String telefono, String nombreUsuario, String contraseña,
    ...
    public static void registrarAsistente() {
        ...
        if (rol == Rol.GERENTE) {
            ...
            Asistente newAsistente = new Asistente(nombre, apellido, fechaNacimiento, telefono, nombreUsuario, clave, sueldo, RFC, INE);
