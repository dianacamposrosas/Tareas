...
public class Cliente extends Usuario {
    ...
    public Cliente(String nombre, String apellido, LocalDate fechaNacimiento, String telefono, String nombreUsuario, String contraseña) {
...
//    @Override //Indica que se está sobre escribiendo un método, por eso sale
    ...
    public static void registrarCliente() {
        ...
        Cliente cliente = new Cliente(nombre, apellido, fechaNacimiento, telefono, nombreUsuario, contraseña);
